/****************************************************************************
** Meta object code from reading C++ file 'wifi.hpp'
**
...
#error "The header file 'wifi.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 21, 16), // "QAbstractButton*"
QT_MOC_LITERAL(4, 38, 8), // "m_button"
QT_MOC_LITERAL(5, 47, 7), // "refresh"
QT_MOC_LITERAL(6, 55, 11), // "receiveText"
QT_MOC_LITERAL(7, 67, 4), // "text"
QT_MOC_LITERAL(8, 72, 8), // "prevPage"
QT_MOC_LITERAL(9, 81, 8) // "nextPage"

    },
    "WifiUI\0handleButton\0\0QAbstractButton*\0"
    "m_button\0refresh\0receiveText\0text\0"
    "prevPage\0nextPage"
};
...
void WifiUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handleButton((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        case 1: _t->refresh(); break;
        case 2: _t->receiveText((*reinterpret_cast< QString(*)>(_a[1]))); break;
